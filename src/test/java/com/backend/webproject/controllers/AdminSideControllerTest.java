...
class AdminSideControllerTest {
        ...
        // @Test
        // public void searchByCartIDTest() throws Exception {

        // this.mockMvc.perform(get("/admin-side/validateCoupon/1"))
        // .andExpect(status().isOk());
        // }
        ...
        public void couponRoutingTest() throws Exception {
                ...
                this.mockMvc.perform(get("/admin-side/updateCoupon/1"))
                                .andExpect(status().isOk())
                                .andExpect(forwardedUrl("/WEB-INF/jsp/updateCouponDataForm.jsp"));
        ...
        public void eventsRoutingTest() throws Exception {
                ...
                this.mockMvc.perform(get("/admin-side/events/deleteEvents/1"))
                                .andExpect(status().is(302))
                                .andExpect(redirectedUrl("/admin-side/events"));
        }
}
